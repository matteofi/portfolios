...
SECRET_KEY = 'django-insecure-r^694wt85()z=3j(_0mr3xnbhfk!t*jb2okez1h&sny-xf)+7m'
...
INSTALLED_APPS = [
    ...
    'portfolios2.apps.Portfolios2Config',
]
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # se lo metti dentro una cartella "static"
]
